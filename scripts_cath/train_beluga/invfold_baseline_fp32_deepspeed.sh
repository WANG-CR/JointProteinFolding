...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/inverse_baseline_4.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/inverse_baseline_4.err
...
srun python train_invfold.py --train_data_dir $TRAIN_DIR \
    ...
    --wandb_version invfold_baseline4\
    --wandb_project pf_toy \
    --train_epoch_len 1000 \
    --deepspeed_config_path deepspeed_config_32.json \