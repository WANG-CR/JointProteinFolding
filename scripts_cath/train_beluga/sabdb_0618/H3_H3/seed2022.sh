...
#SBATCH --exclusive
#SBATCH --output=/home/tjhec/scratch/antibody/alphafold/output/slurm_log/sabdab0618_H3_H3_seed2022.out
#SBATCH --error=/home/tjhec/scratch/antibody/alphafold/output/slurm_log/sabdab0618_H3_H3_seed2022.err
...
srun python train_antibody.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --wandb_version sabdab0618_H3_H3_2022 \
