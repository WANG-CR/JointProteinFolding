...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/joint_baseline_v1.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/joint_baseline_v1.err
...
srun python train_joint.py --train_data_dir $TRAIN_DIR \
    ...
    --wandb_version joint_baseline_v1 \
