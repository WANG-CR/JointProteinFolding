...
#SBATCH --time=3:00:00
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/cath_gen/output/slurm_log/hastype_short_v1.out
#SBATCH --error=/home/shichenc/scratch/cath_gen/output/slurm_log/hastype_short_v1.err
...
srun python train_cath.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --seed 2022 \
    --yaml_config_preset yaml_config/hastype.yml \
