...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/inverse_baseline_3.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/alphafold/output/slurm_log/inverse_baseline_3.err
...
srun python train_invfold.py --train_data_dir $TRAIN_DIR \
    ...
    --wandb_version invfold_baseline3\
