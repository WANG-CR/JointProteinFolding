...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/wm20000_long_esm_v1.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/wm20000_long_esm_v1.err
...
YAML_CONFIG_PRESET=wm20000_long_esm
