...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/wm20000_v1.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/wm20000_v1.err
