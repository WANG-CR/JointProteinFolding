...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/oas_cat_attn_v2.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/oas_cat_attn_v2.err
