...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/cat_refine_finetune.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/cat_refine_finetune.err
