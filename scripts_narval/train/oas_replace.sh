...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/oas_replace_v1.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/oas_replace_v1.err
