...
#SBATCH --exclusive
#SBATCH --output=/home/shichenc/scratch/biofold/output/slurm_log/cat_v2.out
#SBATCH --error=/home/shichenc/scratch/biofold/output/slurm_log/cat_v2.err
