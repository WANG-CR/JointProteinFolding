...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/mini_finetune_SEQ_foldingBaselineDay1.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/mini_finetune_SEQ_foldingBaselineDay1.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python finetune_joint.py $TRAIN_DIR \
    ...
    --wandb_version mini_finetune_SEQ_foldingBaselineDay1 \
