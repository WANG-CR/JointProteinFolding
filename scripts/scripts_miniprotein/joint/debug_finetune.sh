...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/debug_finetune_ReconsLoss.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/debug_finetune_ReconsLoss.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python finetune_joint.py $TRAIN_DIR \
    ...
    --wandb_version debug_finetune_ReconsLoss \
