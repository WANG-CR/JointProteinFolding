...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/replace_fp32_v2.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/replace_fp32_v2.err

# v2: apply weight decay to deminish NaN problem
ENV_NAME=fold3
...
# hight learning rate, low weight decay = 1e-6
