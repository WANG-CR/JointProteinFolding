...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/replace_fp32_v4.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/replace_fp32_v4.err

# v4: apply weight decay to deminish NaN problem
ENV_NAME=fold3
