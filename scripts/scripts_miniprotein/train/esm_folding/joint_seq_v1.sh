...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/esmfold_joint_seq_v1.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/esmfold_joint_seq_v1.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python finetune_joint.py $TRAIN_DIR \
    ...
    --wandb_version esmfold_joint_seq_v1 \
