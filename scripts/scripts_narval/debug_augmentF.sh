...
TRAIN_DIR=/home/chuanrui/scratch/data/structure_datasets/cath/processed/top_split_512_2023_0.01_0.04_valid
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/data_augment/baseline_bs1.yml \
    --precision 16  --gpus 1 --log_every_n_steps 2 \
    --wandb true \
    --wandb_entity chuanrui \
    --wandb_version debug_gpu1_run2 \
