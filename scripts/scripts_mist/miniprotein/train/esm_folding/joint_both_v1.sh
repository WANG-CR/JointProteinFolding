...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/esmfold_joint_both_v1.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output_miniprotein/slurm_log/esmfold_joint_both_v1.err
...
# should be compared with the curve of "replace_esmFold_16layer-esmfold_fp32_v2_lowLR"
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_joint.py $TRAIN_DIR \
    ...
    --wandb_version esmfold_joint_both_v1 \
