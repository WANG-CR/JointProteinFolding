...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/corrige_fp32_v4.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/corrige_fp32_v4.err
...
# continuously training after corrige_fp32_v2
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_protein.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --wandb_version corrige_fp32_v4 \
    --wandb_project corrige_pf \
    --train_epoch_len 1000 \
    --resume_from_ckpt $OUTPUT_DIR/corrige_pf/replace_esmFold_lowLR-corrige_fp32_v3/checkpoints/epoch83-step20999-val_loss=2.491.ckpt \