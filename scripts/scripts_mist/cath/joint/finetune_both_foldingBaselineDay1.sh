...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/finetune_both_foldingBaselineDay1.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/finetune_both_foldingBaselineDay1.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_joint.py $TRAIN_DIR \
    ...
    --wandb_version finetune_both_foldingBaselineDay1 \
