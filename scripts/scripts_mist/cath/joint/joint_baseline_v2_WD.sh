...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/joint_baseline_fp32_v2_WD.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/joint_baseline_fp32_v2_WD.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_joint.py $TRAIN_DIR \
    ...
    --wandb_version joint_baseline_fp32_v2_WD \
