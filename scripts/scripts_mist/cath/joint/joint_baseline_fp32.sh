...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/joint_baseline_fp32_v1.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/joint_baseline_fp32_v1.err
...
# joint baseline 1 configuration: fp32, lm finetune, small set of sequence data
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_joint.py $TRAIN_DIR \
    ...
    --wandb_version joint_baseline_fp32_v1 \
