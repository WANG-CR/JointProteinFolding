...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/replace_baseline_fp32_v4_WD_day2.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/replace_baseline_fp32_v4_WD_day2.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_protein.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --wandb_version replace_baseline_fp32_v4_WD_day2 \
    --wandb_project mist_pf \
    --train_epoch_len 1000 \
    --resume_from_ckpt $OUTPUT_DIR/mist_pf/replace-replace_baseline_fp32_v4_WD/checkpoints/epoch51-step12999-val_loss=2.708.ckpt \
