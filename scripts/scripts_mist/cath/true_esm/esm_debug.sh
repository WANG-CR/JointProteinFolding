...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/esmfold_debug.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/esmfold_debug.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_esmfold.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --precision 32 --gpus 1 --log_every_n_steps 5 \
    --wandb false \
    --train_epoch_len 10 \
