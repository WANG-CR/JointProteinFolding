...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output_esm/slurm_log/esmfold_withMLM.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output_esm/slurm_log/esmfold_withMLM.err
