...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_bs32.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_bs32.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/joint_finetune/debug_bs32.yml \
