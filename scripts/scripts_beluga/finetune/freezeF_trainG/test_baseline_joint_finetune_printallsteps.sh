...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_printallsteps_joint_finetune1.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_printallsteps_joint_finetune1.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF.py $TRAIN_DIR \
    ...
    --wandb_version debug_printallsteps_joint_finetune3 \
