...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune_16bs_noEMA.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune_16bs_noEMA.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF_noEMA.py $TRAIN_DIR \
    ...
    --wandb_version debug_finetune_16bs_noEMA \
