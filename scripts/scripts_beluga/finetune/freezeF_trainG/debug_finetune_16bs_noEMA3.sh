...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune_16bs_noEMA2_P2.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune_16bs_noEMA2_P2.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF_noEMA.py $TRAIN_DIR \
    ...
    --resume_from_ckpt /home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/output/finetune/debug_beluga/debug_bs16-debug_finetune_16bs_noEMA2/checkpoints/epoch06-step139-val_loss=1.710.ckpt \
    ...
    --wandb_version debug_finetune_16bs_noEMA2_P2 \
