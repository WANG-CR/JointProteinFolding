...
#SBATCH --time=6:00:00
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_100sample_2bs.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_100sample_2bs.err
#SBATCH --qos=main
...
TRAIN_DIR=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/toydata/sample_100
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/joint_finetune/debug_bs2.yml \
    ...
    --wandb_version debug_100sample_2bs \
