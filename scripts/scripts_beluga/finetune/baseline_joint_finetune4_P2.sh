...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/baseline_finetune_beluga_1node_run3_P2.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/baseline_finetune_beluga_1node_run3_P2.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF.py $TRAIN_DIR \
    ...
    --wandb_version baseline_finetune_beluga_1node_run3_P2 \
    --wandb_project debug_beluga \
    --resume_from_ckpt output/finetune/debug_beluga/esm3B+8inv_samlldim_4ddp-baseline_finetune_beluga_1node_run3/checkpoints/epoch07-step399-val_loss=2.918.ckpt \
