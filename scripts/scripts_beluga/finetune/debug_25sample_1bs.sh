...
#SBATCH --time=4:00:00
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_25sample_1bs.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_25sample_1bs.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_joint_freezeF.py $TRAIN_DIR \
    ...
    --wandb_version debug_25sample_1bs \
