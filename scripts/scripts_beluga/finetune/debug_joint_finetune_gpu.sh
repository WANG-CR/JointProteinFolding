...
#SBATCH --time=0:30:00
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/debug_finetune.err
#SBATCH --qos=unkillable


ENV_NAME=pf2 # your environment name
module load cuda/11.2.2 # load cuda modules if neede
