...
#SBATCH --time=1:00:00
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/benchmark/baseline_standard_lr5e-4_block8_EMA_epoch161.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/benchmark/baseline_standard_lr5e-4_block8_EMA_epoch161.err
#SBATCH --qos=main
