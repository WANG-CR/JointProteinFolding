...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/protseed_inverse_standard2_P2.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/protseed_inverse_standard2_P2.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_invfold.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/baseline_inverse/protseed2.yml \
    --precision 32  --log_every_n_steps 5 \
    --gpus 4 \
    --wandb true \
    --wandb_entity chuanrui \
    --wandb_version protseed_inverse_standard2_P2 \
    --wandb_project debug_beluga \
    --resume_from_ckpt output/inverse/debug_beluga/protseed2-protseed_inverse_standard2/checkpoints/epoch06-step15770-val_loss=1.821.ckpt \
