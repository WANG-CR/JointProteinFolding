...
#SBATCH --exclusive
#SBATCH --output=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/baseline_domain4.out
#SBATCH --error=/home/chuanrui/scratch/research/ProteinFolding/JointProteinFolding/slurm_log/baseline_domain4.err
#SBATCH --qos=main
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_invfold.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/baseline_inverse/inverse_block8_bs1_lr1e-3_yml \
    --precision 32  --log_every_n_steps 5 \
    --train_epoch_len 1000 \
    --gpus 4 \
    --wandb true \
    --wandb_entity chuanrui \
    --wandb_version baseline_domain4 \
