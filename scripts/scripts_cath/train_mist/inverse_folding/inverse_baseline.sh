...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/inverse_baseline_amp16.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/inverse_baseline_amp16.err
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_invfold.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --wandb_version inverse_baseline_amp16 \
