...
TEST_DIR=$DATA_DIR/top_split_512_2023_0.01_0.04_test  # test data path
...
python predict_protein.py \
    $TEST_DIR \
    --resume_from_ckpt /home/Xcwang/scratch/JointProteinFolding/output_cath/debug_endeavour/baseline_8layer_3B_largebs-cath_baseline_bs16_epochlen7680_step165_P2/checkpoints/epoch140-step1409-val_loss=2.418.ckpt \
    --is_antibody false \
