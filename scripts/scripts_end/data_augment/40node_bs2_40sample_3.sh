...
#SBATCH --constraint="dnp8480"
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_40sample_trainF_run3.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_40sample_trainF_run3.err
...
TRAIN_DIR=/nfs/work04/chuanrui/data/subset_120_noleakage/test # train data path
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/data_augment/baseline_bs2_tm.yml \
    ...
    --wandb_version 40sample_40node_2bs_run3 \
