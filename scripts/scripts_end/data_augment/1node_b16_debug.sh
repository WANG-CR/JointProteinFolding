...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_16bs_debug_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_16bs_debug_trainF.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --wandb_version debug_1node_16bs \
