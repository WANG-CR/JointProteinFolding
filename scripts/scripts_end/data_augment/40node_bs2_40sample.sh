...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_40sample_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_40sample_trainF.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --wandb_version 40sample_40node_2bs \
