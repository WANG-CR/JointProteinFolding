...
#SBATCH --output=log/debug_trainF.out
#SBATCH --error=log/debug_trainF.err
...
TRAIN_DIR=/nfs/work04/chuanrui/data/sampled_protein # train data path
VALID_DIR=/nfs/work04/chuanrui/data/sampled_protein # test data path
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/data_augment/baseline_bs16.yml \
