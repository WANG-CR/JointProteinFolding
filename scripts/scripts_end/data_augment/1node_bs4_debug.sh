...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_4bs_debug_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_4bs_debug_trainF.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --seed 2024 \
    --yaml_config_preset yaml_config/data_augment/baseline_bs4.yml \
    --precision 32  --log_every_n_steps 2 \
    --train_epoch_len 96 \
    --accelerator cpu \
    --wandb true \
    --wandb_entity chuanrui \
    --wandb_version debug_1node_4bs \
