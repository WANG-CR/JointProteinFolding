...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/2node_debug_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/2node_debug_trainF.err
