...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_70Ksample_trainF_run1.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_70Ksample_trainF_run1.err
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --wandb_version 70Ksample_40node_2bs_run1 \
