...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_debug_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/40node_2bs_debug_trainF.err
...
TRAIN_DIR=/nfs/work04/chuanrui/data/subset_1200_noleakage/test # train data path
...
TORCH_DISTRIBUTED_DEBUG=DETAIL srun python train_esmfold_from_pretrained.py $TRAIN_DIR \
    ...
    --wandb_version debug_40node_2bs \
