...
#SBATCH --output=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_2bs_debug_trainF.out
#SBATCH --error=/home/Xcwang/scratch/beluga/JointProteinFolding/log/1node_2bs_debug_trainF.err
