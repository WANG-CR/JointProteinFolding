...
#SBATCH --output=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/train_inverseFoldingModel_example.out
#SBATCH --error=/scratch/b/bengioy/chuanrui/backup/alphafold/output/slurm_log/train_inverseFoldingModel_example.err

# 1. activate environment
ENV_NAME=fold3 # your environment name
module load cuda/11.2 # load cuda package if needed
...
#   resume_from_ckpt: whether or not loading from a pretrained checkpoint
...
TORCH_DISTRIBUTED_DEBUG=INFO srun python train_invfold.py $TRAIN_DIR $OUTPUT_DIR \
    ...
    --wandb_version train_inverseFoldingModel_example \
